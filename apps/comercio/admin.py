...
from apps.comercio.models import (
    Comercio,
    Domicilio,
    Pago,
    Telefono,
...
class ComercioAdmin(admin.ModelAdmin):
    list_display = ('codigo', 'nombre', 'rubro', 'descripcion',
                    'disponibilidad', 'domicilio', 'imagen')


class DomicilioAdmin(admin.ModelAdmin):
    list_display = ('codigo', 'calle', 'numero', 'coordenadas',
                    'localidad')
